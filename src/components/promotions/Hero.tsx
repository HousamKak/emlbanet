...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[60vh] md:min-h-[68vh] overflow-hidden bg-gradient-to-b from-[--color-cream] to-white flex items-center">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold text-[--color-brown] mb-5 md:mb-6 leading-snug"
          >
            {t('hero.title')}
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-2xl font-medium text-[--color-terracotta] leading-relaxed mb-7 md:mb-8"
          >
            {t('hero.subtitle')}
          </motion.p>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-[--color-brown-light] mb-12 md:mb-14 max-w-md leading-relaxed"
          >
            {t('hero.catering')}
          </motion.p>
          ...
          >
            <a
              href="#menu"
              className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-full bg-[--color-olive] text-white font-semibold text-base shadow-lg shadow-[--color-olive]/20 transition-all duration-200 hover:bg-[--color-olive-dark] hover:shadow-xl hover:shadow-[--color-olive]/30 hover:scale-105"
            >
          ...
          <motion.div
            ...
            className="mt-12 md:mt-16 flex flex-wrap items-center justify-center gap-5 md:gap-6 text-sm text-[--color-brown-light]"
          >
