  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5">
        {/* Title */}
        <h3 className="text-base md:text-lg font-bold text-[--color-brown] mb-2 leading-snug line-clamp-1">
          {name}
        </h3>

        {/* Serves info */}
        {item.serves && (
          <p className="text-xs text-[--color-brown-light] mb-4 flex items-center gap-1 leading-snug">
            ...
            <div className="flex flex-wrap gap-2.5">
              {item.options.map(option => (
                <button
                  ...
                  className={`px-3.5 py-2.5 rounded-lg text-xs font-medium leading-snug transition-all duration-200 ${
